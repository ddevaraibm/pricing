...
Sie können Apps kostenfrei in {{site.data.keyword.Bluemix}} ausführen und {{site.data.keyword.Bluemix_notm}}-Services testen. Sie können sich für einen kostenfreien 30-Tage-Test anmelden, bei dem Sie zusätzliche Leistungen, einschließlich kostenloser Unterstützung, erhalten. Nach 30 Tagen können Sie sich entscheiden, ein Upgrade auf einen anderen Kontotyp durchzuführen, und nur für das bezahlen, was Sie über die kostenfreien Leistungen hinaus nutzen. Bluemix stellt Ihnen eine Berechnungsfunktion zur Verfügung, sodass Sie die Kosten im Voraus einschätzen können, sowie die Ansicht 'Nutzungsdashboard', in der Sie die tatsächlichen Kosten nach dem Erstellen Ihrer Apps überprüfen können.
{:shortdesc}

## Anmeldung für ein kostenloses Testkonto
{: #trial}
Sie können sich für einen kostenfreien 30-Tage-Test mit Ihrer {{site.data.keyword.Bluemix_notm}}-ID registrieren. Während des Testzeitraums können Sie in {{site.data.keyword.Bluemix_notm}} Apps entwickeln und Services nutzen.
...
Ihr kostenloser Testzeitraum läuft 30 Tage nach Ihrer Registrierung ab; an diesem Punkt werden die Apps in Ihrem Konto gestoppt. Sie können sich zwar nicht für ein weiteres Testkonto in {{site.data.keyword.Bluemix_notm}} anmelden, Sie können jedoch weiterhin auf Ihr Konto und die Konten zugreifen, für die Sie eingeladen wurden. Zum erneuten Starten Ihrer Anwendungen müssen Sie entweder Ihre Kreditkarteninformationen für ein nutzungsabhängiges Konto angeben oder ein Konto vom Typ Abonnement erstellen. Nach dem Konvertieren Ihres Testkontos können Sie mit der Verwendung der kostenlosen Rechen- und Serviceressourcen fortfahren. Sie zahlen nur für die Nutzung von Services, Containern und Laufzeiten, die nicht durch die kostenlosen Monatsleistungen abgedeckt ist.

Wenn Sie Ihr Konto nach Ablauf des kostenlosen Testzeitraums nicht konvertieren, empfangen Sie E-Mail-Benachrichtigungen über Ihren Kontostatus. Die Benachrichtigungen erinnern Sie daran, ein gebührenpflichtiges Konto zu erstellen, damit Ihre Appeinstellungen und -konfigurationen nicht verloren gehen. Wenn Sie diese Benachrichtigungen von {{site.data.keyword.Bluemix_notm}} nicht empfangen möchten, können Sie das Abonnement jederzeit beenden.
...
Klicken Sie zum Verwenden eines Werbecodes in der {{site.data.keyword.Bluemix_notm}}-Konsole auf **Verwalten** &gt; **Abrechnung und Nutzung** &gt; **Abrechnung**. Geben Sie die Werbedetails ein und klicken Sie auf **Anwenden**.
...
## Anmeldung für ein belastbares Konto
{: #pay-accounts}
...
Als Kontoeigner können Sie Ihre Informationen, einschließlich der gespeicherten Kreditkartendaten, nach der Erstellen eines belastbaren Kontos bearbeiten. Klicken Sie auf **Verwalten** &gt; **Abrechnung und Nutzung** &gt; **Abrechnung**, um die Details anzuzeigen oder zu ändern.
...
**Hinweis:** Wenn Sie Ihr {{site.data.keyword.Bluemix_notm}}-Abrechnungskonto mit einem SoftLayer-Konto verknüpfen, werden Ihre {{site.data.keyword.Bluemix_notm}}- und SoftLayer-Gebühren ab dem Ersten des folgenden Monats über die {{site.data.keyword.Bluemix_notm}}-Rechnung abgerechnet. Weitere Informationen finden Sie unter [Guthaben anzeigen](/docs/pricing/manage_billing.html#linked_usage).

### Nutzungsabhängiges Konto
{: #upgradetopayg}

Wenn Sie sich mit einem Testkonto bei {{site.data.keyword.Bluemix_notm}} anmelden, können Sie nicht auf das Infrastruktur-Dashboard zugreifen. Wenn Ihre Apps die Infrastrukturressourcen nutzen sollen, müssen Sie Ihr Konto auf ein nutzungsabhängiges Konto aktualisieren.

Um für Ihr Testkonto ein Upgrade auf ein nutzungsabhängiges {{site.data.keyword.Bluemix_notm}}-Konto durchzuführen, rufen Sie die Seite **Verwalten** > **Abrechnung und Nutzung** > **Abrechnung** in der Konsole auf und klicken Sie auf **Kreditkarte hinzufügen**.
...
Akzeptieren Sie nach der Angabe Ihrer Abrechnungs- und Kreditkarteninformationen die Vertragsbedingungen und schicken Sie Ihre Anforderung ab. Ihre Kreditkarteninformationen werden geprüft. Es wird auch eine Bestätigungs-E-Mail für die Kontoinformationen gesendet. Einige Minuten nach Empfang der Bestätigungs-E-Mail können Sie zu {{site.data.keyword.Bluemix_notm}} zurückkehren, um mit der Erstellung Ihrer Apps fortzufahren. Wenn {{site.data.keyword.Bluemix_notm}} Ihre Onlineanforderung für Ihr Land oder Ihre Region nicht verarbeiten kann, können Sie sich an den {{site.data.keyword.Bluemix_notm}}-Vertrieb wenden. Verwenden Sie dazu den auf der Seite für den [{{site.data.keyword.Bluemix_notm}}-Support ![Symbol für externen Link](../icons/launch-glyph.svg)](http://ibm.biz/bluemixsupport){: new_window} aufgeführten Link.
