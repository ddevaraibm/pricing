...
To open the Usage Details view, click the **{{site.data.keyword.avatar}}** icon ![Avatar icon](../icons/i-avatar-icon.svg) &gt; **Account** &gt; *your_account_name* &gt; **Usage Details**. In the view, you can see a summary of the runtime and service usage for the account.
...
To open the **Notifications** view, click the **{{site.data.keyword.avatar}}** icon ![Avatar icon](../icons/i-avatar-icon.svg) &gt; **Account** &gt; *your_account_name* &gt; **Notifications**. Enter a numeric value to set the spending threshold for triggering a notification for each type of spending notification as needed. You can also add and delete notifications for individual services.
...
## general
{: general}
* [{{site.data.keyword.Bluemix_notm}} Pricing Sheet ![External link icon](../icons/launch-glyph.svg "External link icon")](https://console.{DomainName}/pricing/){: new_window}
* [{{site.data.keyword.Bluemix_notm}} Developers Community Forum ![External link icon](../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/bluemix/){: new_window}
* [Getting online help](/docs/troubleshoot/getting_customer_support.html#online_help)
* [Contact us ![External link icon](../icons/launch-glyph.svg "External link icon")](https://ace.ng.bluemix.net/#/contactUs/cloudOEPaneId=contactUs){: new_window}
